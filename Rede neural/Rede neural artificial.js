...
// sinh = seno hiperbolica / cosh = coseno hiperbolica
function tanh(n=0) { return Math.sinh(n) / Math.cosh(n) }

//função sigmoid: retorna valores entre 0 e 1
//Math.E = constante de Euler //Math.pow = potencia 
...
retorna somente valores maiores que zero*/
